            ...
            onUserUpdated({
                ...
                department: values.departmentId
                    ? {
                        ...
                        name: departments.find((d) => d.id === values.departmentId)?.name || user.department?.name || "",
                    }
                    : undefined,
            })
        } catch (error) {
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[600px]">
                <DialogHeader>
                    ...
                    <DialogDescription>Update the user details. Click save when you're done.</DialogDescription>
                </DialogHeader>
